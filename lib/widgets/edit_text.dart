      ...
      child: Column(
        ...
        children: [
          ReactiveTextField(
            ...
            onEditingComplete: !finishAutofill
                ? null
                : (control) {
            ...
            decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  ...
                  borderSide: BorderSide(
                      color: hasBorder
                          ? LightColors.EDIT_BORDER_FOCUSED_COLOR
                          : color),
                ),
            ...
            validationMessages: {
              ValidationMessage.required: (control) =>
                  Strings.This_field_required.tr,
              ValidationMessage.email: (control) =>
                  Strings.Incorrect_mail_entry.tr,
              ValidationMessage.minLength: (control) =>
                  Strings.Password_less_characters.tr,
              ValidationMessage.mustMatch: (control) =>
                  Strings.Password_does_not_match.tr,
            },
          ),
        ],
      ),
