...
class CustomLoading {
  ...
  static showSuccessToast({required String msg}){
    BotToast.showSimpleNotification(
      ...
      titleStyle: Get.textTheme.bodyText1?.copyWith(fontWeight: FontWeight.bold, fontSize: 14.0, color: Colors.white),
  ...
  static showInfoToast({required String msg}){
    BotToast.showSimpleNotification(
      ...
      titleStyle: Get.textTheme.bodyText1?.copyWith(fontWeight: FontWeight.bold, fontSize: 14.0),
      duration: const Duration(seconds: 3),
      );
  }
