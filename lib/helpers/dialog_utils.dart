...
import 'package:netflix/widgets/my_button.dart';
import 'package:netflix/widgets/programs_custom_radio.dart';
...
class DialogUtils {
                    ...
                    Expanded(
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          onPrimary: LightColors.TEXT_PRIMARY_COLOR, // foreground
                        ),
  ...
  static Future<String?> showCopyProgramDialog(BuildContext context, programList,
