...
class Styles {
  ...
  static TextTheme getTextTheme({required bool isLightTheme,TextStyle? textStyle}) => TextTheme(
        button: MyFonts.BUTTON_TEXT_STYLE.copyWith(fontSize: MyFonts.BUTTON_TEXT_SIZE),
        bodyText1: (textStyle ?? MyFonts.BODY_TEXT_STYLE).copyWith(fontWeight: FontWeight.w100, fontSize: MyFonts.BODY1_TEXT_SIZE, color: isLightTheme ? LightColors.TEXT_PRIMARY_COLOR : DarkColors.TEXT_PRIMARY_COLOR),
        bodyText2: (textStyle ?? MyFonts.BODY_TEXT_STYLE).copyWith(fontSize: MyFonts.BODY2_TEXT_SIZE, color: isLightTheme ? LightColors.TEXT_PRIMARY_COLOR : DarkColors.TEXT_PRIMARY_COLOR),
        headline1: (textStyle ??  MyFonts.HEADLINE_TEXT_STYLE).copyWith(fontSize: MyFonts.HEADLINE1_TEXT_SIZE, fontWeight: FontWeight.bold, color: isLightTheme ? LightColors.TEXT_PRIMARY_COLOR : DarkColors.TEXT_PRIMARY_COLOR),
        headline2: (textStyle ?? MyFonts.HEADLINE_TEXT_STYLE).copyWith(fontSize: MyFonts.HEADLINE2_TEXT_SIZE, fontWeight: FontWeight.bold, color: isLightTheme ? LightColors.TEXT_PRIMARY_COLOR : DarkColors.TEXT_PRIMARY_COLOR),
        headline3: (textStyle ?? MyFonts.HEADLINE_TEXT_STYLE).copyWith(fontSize: MyFonts.HEADLINE3_TEXT_SIZE, fontWeight: FontWeight.bold, color: isLightTheme ? LightColors.TEXT_PRIMARY_COLOR : DarkColors.TEXT_PRIMARY_COLOR),
        headline4: (textStyle ?? MyFonts.HEADLINE_TEXT_STYLE).copyWith(fontSize: MyFonts.HEADLINE4_TEXT_SIZE, fontWeight: FontWeight.bold, color: isLightTheme ? LightColors.TEXT_PRIMARY_COLOR : DarkColors.TEXT_PRIMARY_COLOR),
        headline5: (textStyle ?? MyFonts.HEADLINE_TEXT_STYLE).copyWith(fontSize: MyFonts.HEADLINE5_TEXT_SIZE, fontWeight: FontWeight.bold, color: isLightTheme ? LightColors.TEXT_PRIMARY_COLOR : DarkColors.TEXT_PRIMARY_COLOR),
        headline6: (textStyle ?? MyFonts.HEADLINE_TEXT_STYLE).copyWith(fontSize: MyFonts.HEADLINE6_TEXT_SIZE, fontWeight: FontWeight.bold, color: isLightTheme ? LightColors.TEXT_WHITE_COLOR : DarkColors.TEXT_PRIMARY_COLOR),
        caption: TextStyle(color: LightColors.TEXT_SECONDARY_COLOR , fontSize: MyFonts.CAPTION_TEXT_SIZE),
      );
